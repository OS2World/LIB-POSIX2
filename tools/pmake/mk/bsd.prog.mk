#$Header: /cvsroot/posix2/posix2/tools/pmake/mk/bsd.prog.mk,v 1.2 2000/05/17 08:10:17 veit Exp $
...
.SUFFIXES: .out .exe .o .obj .c .cc .C .cxx .y .l .def .s .8 .7 .6 .5 .4 .3 .2 .1 .0
...
.if !target(clean)
clean: _SUBDIRUSE
	rm -f a.out [Ee]rrs mklog core *.core *.exe \
