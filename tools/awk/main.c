/*	$Id: main.c,v 1.2 2000/08/14 16:26:07 amai Exp $	*/
/****************************************************************
...
const char	*version = "version 19990416";
...
int	dbg	= 0;
const char	*cmdname;	/* gets argv[0] for error messages */
extern	FILE	*yyin;	/* lex input file */
const char	*lexprog;	/* points to program argument if it exists */
extern	int errorflag;	/* non-zero if any syntax errors; set by yyerror */
int	compile_time = 2;	/* for error printing: */
				/* 2 = cmdline, 1 = compile, 0 = running */

const char	*pfile[20];	/* program filenames from -f's */
...
const char *cursource(void)	/* current source file name */
{
	if (npfile > 0)
