/* $Id: proto.h,v 1.2 2000/08/14 16:26:07 amai Exp $	*/
/****************************************************************
...
extern	const char	*cursource(void);
...
extern	void	arginit(int, const char **);
...
extern	int	adjbuf(char **pb, size_t*sz, int min, size_t q, char **pbp, char *what);
...
extern	int	format(char **, size_t*, char *, Node *);
