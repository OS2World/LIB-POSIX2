...
int adjbuf(char **pbuf, size_t *psiz, int minlen, size_t quantum,
	char **pbptr, char *whatrtn)
...
int format(char **pbuf, size_t *pbufsize, char *s, Node *a)	/* printf-like conversions */
{
	char *fmt;
	char *p, *t, *os;
	Cell *x;
